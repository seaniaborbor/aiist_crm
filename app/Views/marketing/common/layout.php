...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/marketing">
            ...
            <li class="nav-item">
                <a class="nav-link" href="/marketing/log_form_sale">
                <i class="fas fa-file-alt"></i>
                    <span>Record Form Sale</span></a>
            </li>

            <li class="nav-item">
                <a class="nav-link" href="/marketing/log_online_inquiry_form">
                <i class="fas fa-clipboard-list"></i>
                <span>Track Online Inquiry</span></a>
            </li>

            <li class="nav-item">
                <a class="nav-link" href="/marketing/personal_profile/<?=session()->get('userId')?>">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item" href="/marketing/personal_profile/<?=session()->get('userId')?>">
